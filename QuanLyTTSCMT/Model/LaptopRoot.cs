...
namespace QuanLyTTSCMT.Model
{
    public class LaptopRoot
    {
        ...
        public LaptopRoot() { }
        public LaptopRoot(string tenNV,string loaiMayTinh,string tenMayTinh,string tenChuMay,DateTime ngayNhanMay,DateTime ngayGiaoMay,string tinhTrang,string thanhTien) 
        {
            TenNV = tenNV;
